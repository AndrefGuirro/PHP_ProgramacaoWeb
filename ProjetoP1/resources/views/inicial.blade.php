...
<body>
    <div class="overlay">
        <div class="content">
            ...
            <p>Cadastre seus produtos e bora ganhar dinheiro.</p>
            <a href="{{ route('produtos.index') }}" class="btn btn-primary btn-lg">Listar produtos</a>
            <a href="{{ route('produtos.create') }}" class="btn btn-success btn-lg">Cadastrar produtos</a>
        </div>
    </div>
